...
\cventry{Since \\ Jan 2015}{\href{http://www.garypaduana.com}{{\color{LinkBlue}Personal Website}}}{}{}{}{A collection of personal projects with live functionality, demonstrations, documentation, and user guides.  Implemented with Grails and Bootstrap CSS; hosted with Amazon Elastic Beanstalk.
	\begin{itemize}
		\item \textit{Bitcoin Taxes} - Analyzes transaction history using FIFO accounting and keeps track of short-term and long-term gains, wash sales, proceeds, and cost basis spanning multiple years of transaction history.  A demonstration feature generates random transaction history based upon historical daily Bitcoin pricing values to show a variety of tax scenarios.  Output is neatly organized using Bootstrap tables to allow one to follow each transaction in fine detail.
		...
		\item \textit{Blog} - Technical studies and interesting findings in technology, programming, engineering, and problem solving (still in early development).
		\item \textit{About/Personal} - Contains a collection of photos I've taken presented using Bootstrap Image Gallery.
	\end{itemize}
}
