...
\cvlistitem{\small \textbf{Master of Science}, Information Security and Assurance, \textit{3.96 GPA}}
\cvlistitem{\small \textbf{Bachelor of Science}, Software Engineering, \textit{3.81 GPA, Magna Cum Laude}}

\subsection{Continued Learning}
\cvitem{2014}{Coursera.org}
\cvlistitem{{\small Current enrollment: \textit{The Data Scientist's Toolbox} and \textit{R Programming}}}
\cvitem{2009}{University of California, Los Angeles, Los Angeles, CA}
\cvlistitem{{\small \textit{Oracle Database 11g: Administration Workshop I}}}
...
\begin{itemize}
	...
	\item Created a process for integrating new vendors into Healthesystems' payment processing system and worked directly with vendor management and development staff.  Assisted multiple vendors in troubleshooting and design as they developed a client application to interface with our exposed SOAP Web Services.
\end{itemize}}
...
\section{Interests}
\cvitem{}{Astronomy, Continued Learning, Digital Storage and Archiving, Economics, Fitness \& Health, Natural Sciences, Philosophy, Photography, Technology, and Wilderness.}
